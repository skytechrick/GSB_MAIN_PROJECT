    ...
    if (Auths != null) {
        ...
        if(len > 0){
            ...
            if(D == "Yes"){
                ...
                let Subtotal = Sub; 
                let ADDRESS = `<address>${Address1.Locality}, ${Address1.Landmark}<br>${Address1.Town}, ${Address1.City},<br>PIN: ${Address1.PIN},  <br>Dist: ${Address1.District_Name}, <br>${Address1.State_Name}, India <br>+91 ${Address1.Mobile} <br> +91 ${Address1.Alt} <br></address>`;
